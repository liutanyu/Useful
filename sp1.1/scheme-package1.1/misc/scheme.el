...
;; Modified by Stephane Hillion to indent and highlight Scheme package
;; constructs.
;; To use this mode, just load this file from your .emacs
...
(put 'syntax-method 'scheme-indent-function 1)
    ...
    (list
     ...
     (list (concat "(\\(define\\("
	   ...
	   '(8 (cond ((match-beginning 3) font-lock-function-name-face)
	       ...
	       nil t))
     ;;
     ;; Scheme package class attribute definitions
     ;;
     (list "(\\(<\\sw+>\\)[ \t]*\\(define\\>\\)[ \t]*(?\\(\\sw+\\)?"
	   '(2 font-lock-keyword-face)
	   '(3 (cond ((match-beginning 3) font-lock-function-name-face)
		     ((match-beginning 6) font-lock-variable-name-face)
		     (t font-lock-type-face))
	       nil t))
     ;;
...
;	       "map" "syntax" "syntax-rules"))
     (cons
      (concat "(\\("
	      ...
	      "m\\(\\|ap\\|ethod\\)\\|or\\|syntax\\(\\|-rules\\|-method\\)"
	      "\\)\\>") 1)
     ;;
