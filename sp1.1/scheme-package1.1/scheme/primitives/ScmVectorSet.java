...
/**
 * The Scheme language 'vector-set!' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/25
 */
public class ScmVectorSet extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmVectorSet INSTANCE = new ScmVectorSet ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    ScmObject[] vec = toVector  (args.get(0)).getValue();
    int         i   = toInteger (args.get(1)).getValue();
    ScmObject   obj = args.get(2);
