...
/**
 * The Scheme language modulo procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/24
 */
public class ScmRemainder extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmRemainder INSTANCE = new ScmRemainder ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNumber(args.get(0)).remainder (toNumber(args.get(1)));
  }
