...
/**
 * The Scheme language 'vector?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/23
 */
public class ScmIsVector extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsVector INSTANCE = new ScmIsVector ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (args.get(0) instanceof ScmVector)
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
