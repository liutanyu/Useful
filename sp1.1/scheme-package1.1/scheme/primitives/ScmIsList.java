...
/**
 * The Scheme language 'list?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/24
 */
public class ScmIsList extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsList INSTANCE = new ScmIsList ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    ScmObject list = args.get(0);

    while ((list instanceof ScmPair) && list != ScmPair.NULL)
      list = ((ScmPair)list).getCdr();

    if (list == ScmPair.NULL)
      return ScmBoolean.T;
    else
      return ScmBoolean.F;
  }
