...
/**
 * The Scheme language expt procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/24
 */
public class ScmExpt extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmExpt INSTANCE = new ScmExpt ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNumber(args.get(0)).expt (toNumber(args.get(1)));
  }
