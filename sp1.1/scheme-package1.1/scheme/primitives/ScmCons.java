...
/**
 * The Scheme language cons procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/10
 */
public class ScmCons extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmCons INSTANCE = new ScmCons ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return new ScmPair (args.get(0), args.get(1));
  }
