...
/**
 * The Scheme language 'pair?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/23
 */
public class ScmIsPair extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsPair INSTANCE = new ScmIsPair ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (args.get(0) instanceof ScmPair && args.get(0) != ScmPair.NULL)
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
