...
/**
 * The Scheme language 'list-tail' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/24
 */
public class ScmListTail extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmListTail INSTANCE = new ScmListTail ();
