...
/**
 * The Scheme language 'boolean?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/10
 */
public class ScmIsBoolean extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsBoolean INSTANCE = new ScmIsBoolean ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (args.get(0) instanceof ScmBoolean)
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
