...
/**
 * The Scheme language 'list->vector' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/24
 */
public class ScmListToVector extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmListToVector INSTANCE = new ScmListToVector ();
