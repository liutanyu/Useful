...
/**
 * The Scheme language 'sin' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/22
 */
public class ScmSin extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmSin INSTANCE = new ScmSin ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNumber(args.get(0)).sin();
  }
