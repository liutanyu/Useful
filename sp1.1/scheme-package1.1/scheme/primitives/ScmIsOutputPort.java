...
/**
 * The Scheme language 'output-port?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/26
 */
public class ScmIsOutputPort extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsOutputPort INSTANCE = new ScmIsOutputPort ();
