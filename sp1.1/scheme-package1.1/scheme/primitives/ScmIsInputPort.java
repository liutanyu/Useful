...
/**
 * The Scheme language 'input-port?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/26
 */
public class ScmIsInputPort extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsInputPort INSTANCE = new ScmIsInputPort ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (args.get(0) instanceof ScmInputPort)
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
