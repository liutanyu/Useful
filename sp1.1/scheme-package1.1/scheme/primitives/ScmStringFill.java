...
/**
 * The Scheme language 'string-fill!' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/25
 */
public class ScmStringFill extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmStringFill INSTANCE = new ScmStringFill ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    char   chr = toChar      (args.get(1)).getValue();
