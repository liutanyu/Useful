...
/**
 * The Scheme language 'char-numeric?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/10
 */
public class ScmIsCharNumeric extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsCharNumeric INSTANCE = new ScmIsCharNumeric ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (Character.isDigit(toChar(args.get(0)).getValue()))
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
