...
/**
 * The Scheme language 'ceiling' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/22
 */
public class ScmCeiling extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmCeiling INSTANCE = new ScmCeiling ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNumber(args.get(0)).ceiling();
  }
