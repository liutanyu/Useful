...
/**
 * The Scheme language 'display' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/26
 */
public class ScmDisplay extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmDisplay INSTANCE = new ScmDisplay ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    op.write (args.get(0).toDisplayString());
