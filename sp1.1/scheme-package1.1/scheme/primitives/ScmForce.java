...
/**
 * The Scheme language 'force'
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/23
 */
public class ScmForce extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmForce INSTANCE = new ScmForce ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
      ...
      return toPromise(args.get(0)).force();
  }
