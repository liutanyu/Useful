...
/**
 * The Scheme language 'truncate' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/23
 */
public class ScmTruncate extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmTruncate INSTANCE = new ScmTruncate ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNumber(args.get(0)).truncate();
  }
