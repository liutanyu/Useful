...
/**
 * The Scheme language 'write-char' procedure
 *
 * @author  Stephane Hillion
 * @version 1.1 - 1998/12/10
 */
public class ScmWriteChar extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmWriteChar INSTANCE = new ScmWriteChar ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    op.write (toChar(args.get(0)).toDisplayString());
