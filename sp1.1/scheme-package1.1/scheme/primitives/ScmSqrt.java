...
/**
 * The Scheme language 'sqrt' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/22
 */
public class ScmSqrt extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmSqrt INSTANCE = new ScmSqrt ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNumber(args.get(0)).sqrt();
  }
