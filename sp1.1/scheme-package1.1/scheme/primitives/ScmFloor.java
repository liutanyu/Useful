...
/**
 * The Scheme language 'floor' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/22
 */
public class ScmFloor extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmFloor INSTANCE = new ScmFloor ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNumber(args.get(0)).floor();
  }
