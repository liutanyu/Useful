...
/**
 * The Scheme language 'round' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/23
 */
public class ScmRound extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmRound INSTANCE = new ScmRound ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNumber(args.get(0)).round();
  }
