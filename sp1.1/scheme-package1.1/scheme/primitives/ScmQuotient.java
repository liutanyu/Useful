 ...
 */
public class ScmQuotient extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmQuotient INSTANCE = new ScmQuotient ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNumber(args.get(0)).quotient (toNumber(args.get(1)));
  }
