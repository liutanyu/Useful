...
/**
 * The Scheme language 'asin' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/22
 */
public class ScmAsin extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmAsin INSTANCE = new ScmAsin ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNumber(args.get(0)).asin();
  }
