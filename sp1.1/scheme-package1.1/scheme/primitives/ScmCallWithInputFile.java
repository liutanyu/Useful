...
/**
 * The Scheme language call-with-input-file procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/26
 */
public class ScmCallWithInputFile extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmCallWithInputFile INSTANCE = new ScmCallWithInputFile ();
  ...
  public String toString () {
    return "#[primitive call-with-input-file]";
  }
}
