...
/**
 * The Scheme language with-input-from-file procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/26
 */
public class ScmWithInputFromFile extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmWithInputFromFile INSTANCE = new ScmWithInputFromFile ();
  ...
  public String toString () {
    return "#[primitive with-input-from-file]";
  }
}
