...
/**
 * The Scheme language 'string->symbol' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/25
 */
public class ScmStringToSymbol extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmStringToSymbol INSTANCE = new ScmStringToSymbol ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return new ScmSymbol (toScmString(args.get(0)));
  }
