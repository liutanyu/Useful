...
/**
 * The Scheme language 'tan' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/22
 */
public class ScmTan extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmTan INSTANCE = new ScmTan ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNumber(args.get(0)).tan();
  }
