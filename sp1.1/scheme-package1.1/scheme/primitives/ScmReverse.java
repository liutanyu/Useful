...
/**
 * The Scheme language 'reverse' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/24
 */
public class ScmReverse extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmReverse INSTANCE = new ScmReverse ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    while (pair != ScmPair.NULL) {
      res = new ScmPair (pair.getCar(), res);
