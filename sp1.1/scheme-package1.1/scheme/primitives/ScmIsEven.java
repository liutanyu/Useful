...
/**
 * The Scheme language 'even?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/10
 */
public class ScmIsEven extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsEven INSTANCE = new ScmIsEven ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if ((toInteger(args.get(0)).getValue() % 2) == 0)
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
