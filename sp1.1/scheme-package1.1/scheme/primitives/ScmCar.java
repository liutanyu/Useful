...
/**
 * The Scheme language car procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/10
 */
public class ScmCar extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmCar INSTANCE = new ScmCar ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNonNullPair(args.get(0)).getCar();
  }
