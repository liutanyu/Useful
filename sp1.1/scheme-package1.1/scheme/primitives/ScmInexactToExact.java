...
/**
 * The Scheme language 'inexact->exact' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/24
 */
public class ScmInexactToExact extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmInexactToExact INSTANCE = new ScmInexactToExact ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (args.get(0) instanceof ScmInteger)
      ...
      return new ScmInteger ((int)toReal(args.get(0)).getValue());
  }
