...
/**
 * The Scheme language current continuation
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/12
 */
public class ScmCC extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmCC INSTANCE = new ScmCC();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    throw new ScmCallCCException (args.get(0));
  }
