...
/**
 * The Scheme language Equal? procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/23
 */
public class ScmIsEqual extends ScmPredefined {

    /**
     * The instance of this class
     */
    public final static ScmIsEqual INSTANCE = new ScmIsEqual ();
	...
	if (args.get(0).isEqual (args.get(1)))
	    return ScmBoolean.T;
	else
	    return ScmBoolean.F;
    }
