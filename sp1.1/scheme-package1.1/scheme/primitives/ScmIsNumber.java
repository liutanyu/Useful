...
/**
 * The Scheme language 'number?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/23
 */
public class ScmIsNumber extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsNumber INSTANCE = new ScmIsNumber ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (args.get(0) instanceof ScmNumber)
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
