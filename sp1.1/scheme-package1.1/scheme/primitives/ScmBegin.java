...
/**
 * The Scheme language 'begin' syntax
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/10
 */
public class ScmBegin extends ScmPredefined implements ScmSyntax {

  /**
   * The instance of this class
   */
  public final static ScmBegin INSTANCE = new ScmBegin ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    for (int i = 0; i < args.size(); i++)
      exps.addReusableLast (args.get(i));
