 ...
 */
public class ScmIsCharEqual extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsCharEqual INSTANCE = new ScmIsCharEqual ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (toChar(args.get(0)).isEqual (toChar(args.get(1))))
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
