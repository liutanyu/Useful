...
/**
 * The Scheme language close-input-port procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/26
 */
public class ScmCloseInputPort extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmCloseInputPort INSTANCE = new ScmCloseInputPort ();
