...
/**
 * The Scheme language 'list->string' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/24
 */
public class ScmListToString extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmListToString INSTANCE = new ScmListToString ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    ScmArray lst  = new ScmArray();

    while (pair != ScmPair.NULL) {
      lst.add (toChar(pair.getCar()));
      pair = toPair (pair.getCdr());
    }

    return new ScmString (lst);
  }
