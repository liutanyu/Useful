...
/**
 * The Scheme language 'procedure?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/23
 */
public class ScmIsProcedure extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsProcedure INSTANCE = new ScmIsProcedure ();
