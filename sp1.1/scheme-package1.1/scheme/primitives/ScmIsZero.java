...
/**
 * The Scheme language 'zero?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/10
 */
public class ScmIsZero extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsZero INSTANCE = new ScmIsZero ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (args.get(0).isEqual (ScmInteger.ZERO))
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
