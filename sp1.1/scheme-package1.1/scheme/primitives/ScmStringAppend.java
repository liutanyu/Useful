...
/**
 * The Scheme language 'string-append' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/10
 */
public class ScmStringAppend extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmStringAppend INSTANCE = new ScmStringAppend ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    for (int i = 0; i < args.size(); i++)
      res = res+toScmString(args.get(i)).toStringWithoutQuotes();
