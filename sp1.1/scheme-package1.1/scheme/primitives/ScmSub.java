...
/**
 * The Scheme language subtraction (-)
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/10
 */
public class ScmSub extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmSub INSTANCE = new ScmSub ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    ScmNumber res = new ScmInteger (0);
    ...
    for (; i < args.size(); i++)
      res = res.sub (toNumber(args.get(i)));
