...
/**
 * The Scheme language set! procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/23
 */
public class ScmSetq extends ScmPredefined implements ScmSyntax {

    /**
     * The instance of this class
     */
    public final static ScmSetq INSTANCE = new ScmSetq ();
	...
	while (!evs.empty() && obj == null) {
	    ScmEnvironment env = (ScmEnvironment)evs.pop();
	    obj = env.find (symb);
	    if (obj != null)
		env.define (symb, ScmKernel.evalAux2 (args.get (1), envs));
	}

	if (obj == null)
	    error ("Undefined symbol: "+symb);
