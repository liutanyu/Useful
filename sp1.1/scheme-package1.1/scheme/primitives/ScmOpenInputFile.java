...
/**
 * The Scheme language open-input-file procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/26
 */
public class ScmOpenInputFile extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmOpenInputFile INSTANCE = new ScmOpenInputFile ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return new ScmInputPort (toScmString(args.get(0)).toStringWithoutQuotes());
  }
