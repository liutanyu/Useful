...
/**
 * The Scheme language 'char-lower-case?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/10
 */
public class ScmIsCharLowerCase extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsCharLowerCase INSTANCE = new ScmIsCharLowerCase ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (Character.isLowerCase(toChar(args.get(0)).getValue()))
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
