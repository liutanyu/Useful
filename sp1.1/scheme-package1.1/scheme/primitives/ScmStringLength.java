...
/**
 * The Scheme language 'string-length' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/25
 */
public class ScmStringLength extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmStringLength INSTANCE = new ScmStringLength ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return new ScmInteger (toScmString (args.get(0)).getLength());
  }
