...
/**
 * The Scheme language 'vector-ref' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/25
 */
public class ScmVectorRef extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmVectorRef INSTANCE = new ScmVectorRef ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    int         obj  = toInteger (args.get(1)).getValue();

    if (obj < 0 || obj >= vect.length)
      error ("Index out of bounds: "+obj);
