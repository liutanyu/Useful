...
/**
 * The Scheme language 'char-upcase' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/24
 */
public class ScmCharUpcase extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmCharUpcase INSTANCE = new ScmCharUpcase ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return new ScmChar (Character.toUpperCase(toChar(args.get(0)).getValue()));
  }
