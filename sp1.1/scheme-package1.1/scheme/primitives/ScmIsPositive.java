...
/**
 * The Scheme language 'positive?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/23
 */
public class ScmIsPositive extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsPositive INSTANCE = new ScmIsPositive ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (toNumber(args.get(0)).greaterThan (ScmInteger.ZERO))
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
