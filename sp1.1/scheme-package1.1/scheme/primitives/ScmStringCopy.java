...
/**
 * The Scheme language 'string-copy' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/25
 */
public class ScmStringCopy extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmStringCopy INSTANCE = new ScmStringCopy ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toScmString (args.get(0)).getCopy();
  }
