...
/**
 * The Scheme language 'symbol->string' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/25
 */
public class ScmSymbolToString extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmSymbolToString INSTANCE = new ScmSymbolToString ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return new ScmString (toSymbol(args.get(0)));
  }
