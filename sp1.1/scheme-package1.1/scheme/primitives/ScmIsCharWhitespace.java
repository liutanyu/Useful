...
/**
 * The Scheme language 'char-whitespace?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/10
 */
public class ScmIsCharWhitespace extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsCharWhitespace INSTANCE = new ScmIsCharWhitespace ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (Character.isSpaceChar(toChar(args.get(0)).getValue()))
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
