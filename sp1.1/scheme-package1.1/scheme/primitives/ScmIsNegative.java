...
/**
 * The Scheme language 'negative?' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/23
 */
public class ScmIsNegative extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsNegative INSTANCE = new ScmIsNegative ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (toNumber(args.get(0)).lessThan (ScmInteger.ZERO))
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
