...
/**
 * The Scheme language 'vector-length' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/25
 */
public class ScmVectorLength extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmVectorLength INSTANCE = new ScmVectorLength ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return new ScmInteger (toVector (args.get(0)).getLength());
  }
