...
/**
 * The Scheme language 'cos' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/22
 */
public class ScmCos extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmCos INSTANCE = new ScmCos ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNumber(args.get(0)).cos();
  }
