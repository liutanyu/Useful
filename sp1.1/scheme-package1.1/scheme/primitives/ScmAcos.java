...
/**
 * The Scheme language 'acos' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/22
 */
public class ScmAcos extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmAcos INSTANCE = new ScmAcos ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return toNumber(args.get(0)).acos();
  }
