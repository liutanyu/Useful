...
/**
 * The Scheme language 'member' procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/24
 */
public class ScmMember extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmMember INSTANCE = new ScmMember ();
