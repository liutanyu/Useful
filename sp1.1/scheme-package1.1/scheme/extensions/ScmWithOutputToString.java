...
/**
 * The Scheme language with-output-to-string procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/26
 */
public class ScmWithOutputToString extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmWithOutputToString INSTANCE = new ScmWithOutputToString ();
  ...
  public String toString () {
    return "#[primitive with-output-to-string]";
  }
}
