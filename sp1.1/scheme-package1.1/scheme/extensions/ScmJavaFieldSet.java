...
/**
 * The interface to "Field.set()" method
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/25
 */
public class ScmJavaFieldSet extends ScmPredefined {

    /**
     * The instance of this class
     */
    public final static ScmJavaFieldSet INSTANCE = new ScmJavaFieldSet ();
	...
	if (!(args.get(2) instanceof ScmJavaObject))
	    error ("java-object expected: "+args.get(2));

	ScmJavaObject obj1 = (ScmJavaObject)args.get(0);
	ScmJavaObject obj2 = (ScmJavaObject)args.get(1);
	ScmJavaObject obj3 = (ScmJavaObject)args.get(3);

	if (!(obj1.getValue() instanceof Field))
	    error ("First argument must be a field: "+obj1);

	try {
	    ((Field)obj1.getValue()).set(obj2.getValue(), obj2.getValue());
  ...
  public String toString () {
    return "#[primitive java-field-set]";
  }
}
