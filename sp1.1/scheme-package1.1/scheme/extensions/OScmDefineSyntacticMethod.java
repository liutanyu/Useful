...
/** 
 * This procedure creates a syntactic method
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/12/18
 */

public class OScmDefineSyntacticMethod extends ScmPredefined implements ScmSyntax {
  /** 
   * The instance of this class
   */
    public final static OScmDefineSyntacticMethod INSTANCE =
	new OScmDefineSyntacticMethod ();

  /**
   * The action of the procedure : create a new syntactic method
   */
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return new OScmSyntacticMethod (params, lparams, exps);
  }
  ...
  public String toString () {
    return "#[primitive syntax-method]";
  }
}
