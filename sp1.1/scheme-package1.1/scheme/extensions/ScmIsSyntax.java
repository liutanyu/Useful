...
/**
 * This procedure tests if the given object is a syntax
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/12/18
 */
public class ScmIsSyntax extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsSyntax INSTANCE = new ScmIsSyntax ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (args.get(0) instanceof ScmSyntax)
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
