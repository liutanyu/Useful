...
/**
 * This procedure tests if the given object is a promise
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/12/12
 */
public class ScmIsPromise extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsPromise INSTANCE = new ScmIsPromise ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    if (args.get(0) instanceof ScmPromise)
      return ScmBoolean.T;
    else
      return ScmBoolean.F;    
  }
