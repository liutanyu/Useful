 ...
 */
public class OScmSyntacticMethod extends ScmProcedure implements OScmMethod, ScmSyntax {
  // Private members
  //
   ...
   * Create a new method
   */
  public OScmSyntacticMethod (ScmArray  params,
			      ScmSymbol lparams,
			      ScmArray  exps) {
    parameters  = params;
    lparameters = lparams;
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    envs.push (((OScmObject)args.get(0)).getFieldEnvironment());
    envs.push (localEnv);
  ...
  public String toString () {
    return "#[syntactic method "+hashCode()+"]";
  }
}
