...
/**
 * The Scheme language open-input-string procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/12/10
 */
public class ScmOpenInputString extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmOpenInputString INSTANCE = new ScmOpenInputString ();
