 ...
 */
public class ScmIsFileExists extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmIsFileExists INSTANCE = new ScmIsFileExists ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    File f = new File (toScmString(args.get(0)).toStringWithoutQuotes());
