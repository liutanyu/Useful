...
/**
 * The interface to "Class.getField()" method
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/25
 */
public class ScmJavaField extends ScmPredefined {

    /**
     * The instance of this class
     */
    public final static ScmJavaField INSTANCE = new ScmJavaField ();
	...
	if (!(obj.getValue() instanceof Class))
	    error ("First argument must be a java.lang.Class");

	try {
	    return new ScmJavaObject (((Class)obj.getValue()).getField (str));
	} catch (NoSuchFieldException e1) {
	    error ("Field not found: "+str);
