...
/**
 * The Scheme language call-with-input-string procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/12/10
 */
public class ScmCallWithInputString extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmCallWithInputString INSTANCE = new ScmCallWithInputString ();
  ...
  public String toString () {
    return "#[primitive call-with-input-string]";
  }
}
