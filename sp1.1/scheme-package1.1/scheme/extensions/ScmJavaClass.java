...
/**
 * The interface to "Class.forName()" method
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/25
 */
public class ScmJavaClass extends ScmPredefined {

    /**
     * The instance of this class
     */
    public final static ScmJavaClass INSTANCE = new ScmJavaClass ();
	...
	String str = toScmString (args.get(0)).toStringWithoutQuotes();

	try {
	    return new ScmJavaObject (Class.forName(str));
