...
/** 
 * This procedure creates a method
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/11/30
 */

public class OScmDefineMethod extends ScmPredefined implements ScmSyntax {
  /** 
   * The instance of this class
   */
  public final static OScmDefineMethod INSTANCE = new OScmDefineMethod ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return new OScmClosure (params, lparams, exps, envs);
  }
