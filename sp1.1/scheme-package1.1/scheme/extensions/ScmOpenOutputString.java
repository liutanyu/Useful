...
/**
 * The Scheme language open-output-string procedure
 *
 * @author  Stephane Hillion
 * @version 1.0 - 1998/12/10
 */
public class ScmOpenOutputString extends ScmPredefined {

  /**
   * The instance of this class
   */
  public final static ScmOpenOutputString INSTANCE = new ScmOpenOutputString ();
  ...
  protected ScmObject apply (ScmArray args, ScmStack envs) throws ScmException {
    ...
    return new ScmOutputPort (new StringWriter ());
  }
